        ...
        <div className="flex flex-col md:flex-row max-w-7xl mx-auto p-4 gap-8 w-full">
            ...
            <aside className="w-full md:w-80 rounded-xl bg-black/5 p-6 dark:bg-white/5 shadow-sm">
                <div className="flex flex-col gap-4">
                    <ImageMap title="最新の活動" image="/images/contact.png" link="/contact" />
                    <ImageMap title="最新の活動" image="/images/product.png" link="/product" />
                    <ImageMap title="最新の活動" image="/images/recruit.png" link="/recruit" />
                </div>
            </aside>
        </div>
    );
